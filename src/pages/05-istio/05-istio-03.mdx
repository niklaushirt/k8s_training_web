...
## 🚀 TASK: Install Bookinfo Demo Application 
...
## 🚀 TASK: Expose the Application via Ingress Gateway
...
Now you can access your application via [http://localhost:8080/productpage](http://localhost:8080/productpage?u=normal)
